...
Актуализированный README для исследовательского baseline по диагностике болезней растений по изображениям листьев. Проект сочетает UNet (сегментация/ROI) и ViT-классификатор в одном inference pipeline и предоставляет локальный HTTP API для тестирования и анализа.
